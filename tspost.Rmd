...
One of the big advantages of the Bayesian structural model, compared to the ARIMA model, is that we can visualize the underlying components. In this example, we're using `ggplot` to plot the average of the MCMC draws for the trend and the seasonal components:
...
As with the airline passenger model above, we can easily visualize the overall contribution of these variables to the model:
