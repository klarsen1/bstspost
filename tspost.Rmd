...
When people think of "data science" they probably think of algorithms that scan large datasets to predict a customer's next move, or interpret unstructured text. But what about modesl that utilize small, time-stamped datasets to predict dry metrics such as demand and sales? Yes, I'm talking about good old time series analysis, an ancient discipline that has not received the cool "data science" re-branding that many other areas of analytics have enjoyed.
