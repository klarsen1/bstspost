---
title: "Forget ARIMA and Go Bayesian"
...
Some important notes about the `bsts` examples in this post:
...
* For simplicity, most of the plots in this post show point estimates from averaging. But it's very easy to get distributions from the MCMC draws, and this is recommended in real life to better quantify uncertainty.
