...
Yet time series analysis present one of the hardest analytical challenges: you typically have the least amount of data, the largest amount of uncertainty, while needing to inform some of the most important decisions. Common use cases involve demand forecasting for corporate planning and high-level allocation of marketing budgets – analyses that directly affect boardroom decisions. At the same time, you rarely have enough good historical data points to estimate seasonality, trend as well as the impact of known business drivers. Validation is more difficult for time series models than it is for classifiers and your audience may not be comfortable with the imbedded uncertainty
